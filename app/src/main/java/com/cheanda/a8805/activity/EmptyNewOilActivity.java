...
public class EmptyNewOilActivity extends BaseActivity implements View.OnTouchListener {
            ...
            case 2:
                ...
                if (isStart) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(EmptyNewOilActivity.this, "运行失败,稍后重试", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                break;
            case 3:
                ...
                if (isStart) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(EmptyNewOilActivity.this, "停止失败,稍后重试", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                break;
    ...
    private void initView() {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.btn_img_popovers_1_1);
        mErrorNew = (ImageView) findViewById(R.id.error_image_new);
        mErrorNew.setImageBitmap(bitmap);
    ...
    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_normal_14);
        mImageView.setImageBitmap(mBitmap);


        mBitmapTop = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_normal_14_1);

        mTop.setImageBitmap(mBitmapTop);

        mStartImage = BItmapUtil.compressBItmap(this, R.mipmap.btn_img_popovers_5);
    ...
    protected void onResume() {
        super.onResume();
        mTimeHandler.postDelayed(mTimeRunnable, 200);
    }
