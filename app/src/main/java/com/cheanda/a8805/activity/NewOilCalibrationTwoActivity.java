...
/*新油校准第2步*/
public class NewOilCalibrationTwoActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_new_3_2);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (x > 65 && x < 300 && y > 580 && y < 639) {
            ...
            Intent intent = new Intent(this, NewOilCalibrationThreeActivity.class);
