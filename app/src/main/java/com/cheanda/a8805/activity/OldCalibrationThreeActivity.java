...
public class OldCalibrationThreeActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_old_3_3);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (x > 65 && x < 300 && y > 580 && y < 639) {
            ...
            Intent intent = new Intent(this, OldCalibrationFourActivity.class);
