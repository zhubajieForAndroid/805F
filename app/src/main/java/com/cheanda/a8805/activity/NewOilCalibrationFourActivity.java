...
public class NewOilCalibrationFourActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private void checkDataForStartAndStop() {
        ...
        if (mIsStart) {
            Intent intent = new Intent(this, NewOilCalibrationFiveActivity.class);
    ...
    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_new_3_4);
