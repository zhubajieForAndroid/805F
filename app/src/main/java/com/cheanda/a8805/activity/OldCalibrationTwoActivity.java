...
/*新油校准第2步*/
public class OldCalibrationTwoActivity extends BaseActivity implements View.OnTouchListener {

    @Bind(R.id.new_Tweo_oil_bg)
    ImageView mNewTweoOilBg;
    @Bind(R.id.number1)
    ImageView mNumber1;
    @Bind(R.id.number2)
    ImageView mNumber2;
    ...
    private static final String TAG = "NewOilCalibrationTwoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_oil_calibrationctivity);
    ...
    private void checkData() {
        mResult = CheckUtil.getOldOilKG(arr);
    ...
    private void initListener() {
        mNewTweoOilBg.setOnTouchListener(this);
    }

    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_old_3_2);
        mNewTweoOilBg.setImageBitmap(mBitmap);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (x > 65 && x < 300 && y > 580 && y < 639) {
            ...
            Intent intent = new Intent(this, OldCalibrationThreeActivity.class);
            startActivity(intent);
            SharedPreferences sp = getSharedPreferences("famaFile", 0);
            SharedPreferences.Editor editor = sp.edit();
            editor.putString("kongpan", mResult);
            editor.commit();
        }
        return false;
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        mNewTweoOilBg.setImageBitmap(null);
        mBitmap.recycle();
