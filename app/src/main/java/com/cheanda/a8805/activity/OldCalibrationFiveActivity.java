...
public class OldCalibrationFiveActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private void checkDataForStartAndStop() {
        ...
        if (mIsStart) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(OldCalibrationFiveActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_old_3_5);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (x > 65 && x < 300 && y > 580 && y < 639) {
            ...
            int gaob = Integer.parseInt(mstr.substring(0, 2), 10);
            int dib = Integer.parseInt(mstr.substring(2, 4), 10);
