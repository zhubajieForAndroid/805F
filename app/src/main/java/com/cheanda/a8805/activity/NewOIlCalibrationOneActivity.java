...
/*新油校准第一步*/
public class NewOIlCalibrationOneActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private void initData() {
        mBitmap = BItmapUtil.compressBItmap(this, R.mipmap.bg_img_new_3_1);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (x > 65 && x < 300 && y > 580 && y < 639) {
            int[] bytes = {0x2a, 0x06, 0x09, 0x07,0x22, 0x23};
            ...
            Intent intent = new Intent(this, NewOilCalibrationTwoActivity.class);
